...
import {agreedMask, assemblyOptions, checkAssembly, formatSyllables, maskWriting, restoreAssembly, restoreWriting, splitSyllables, splitWriting, tiles} from '../src/domain/syllables';
