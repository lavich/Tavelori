  ...
  return (
    <Screen back="Статистика">
      ...
      <p className={ui.note}>
        ...
        {stats.totals.byKind.phrase || stats.totals.byKind.cloze
          ? ` (${withCount(stats.totals.byKind.word, WORDS)} · ${withCount(stats.totals.byKind.phrase, PHRASES)} · ${withCount(stats.totals.byKind.cloze, CLOZES)})`
          : ""}
        .
      </p>
    </Screen>
