...
export interface TelegramThemeParams {
 ...
 secondary_bg_color?:string;header_bg_color?:string;accent_text_color?:string;section_bg_color?:string;section_header_text_color?:string;
 subtitle_text_color?:string;destructive_text_color?:string;bottom_bar_bg_color?:string;section_separator_color?:string;
}
export interface TelegramButton {
 isVisible:boolean;
 show():void;hide():void;
 onClick(handler:()=>void):void;offClick(handler:()=>void):void;
}
export interface TelegramMainButton extends TelegramButton {
 text:string;isActive:boolean;isProgressVisible:boolean;
 setText(text:string):void;enable():void;disable():void;showProgress(leaveActive?:boolean):void;hideProgress():void;
...
export interface TelegramWebApp {
 ...
 BackButton?:TelegramButton;MainButton?:TelegramMainButton;HapticFeedback?:TelegramHapticFeedback;CloudStorage?:TelegramCloudStorage;
